...
<div class="container-fluid no-print" style="background:#006cb7;height:80px;">
	<div class="container">
	<div class="row">
      <div class="col-sm-3" style="padding:10px;"><a href="index.php"><img src="<?php echo base_url();?>system-logo/<?php echo $systemInfo['logo']; ?>" class="img-responsive header_logo" style="max-height:63px;"></a></div>
