...
function setCurrent(idx){
  ...
  blocks.forEach(b=>b.classList.remove('q-current'));
  badges.forEach(b=>b.classList.remove('q-current'));
  blocks[idx].classList.add('q-current');
...
/* -----------------------------------
   Your existing autosave (enhanced with status dot)
----------------------------------- */
