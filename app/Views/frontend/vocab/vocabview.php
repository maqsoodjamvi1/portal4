                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <div class="student-list d-flex flex-wrap">
                            ...
                            <div class="student-item mb-2 mr-2">
        ...
        if (summary) {
            ...
            summaryCard.innerHTML = `
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="mb-1"><i class="fas fa-chart-bar mr-2"></i>Vocabulary Summary</h5>
                            <p class="mb-0">
                                <span class="badge badge-primary mr-2">${summary.total_topics} Topics</span>
                                <span class="badge badge-success">${summary.total_words} Words</span>
                            </p>
                        </div>
            ...
            subjectTopics.forEach((topic, topicIndex) => {
                ...
                html += `
                    <div class="card mb-3">
                        <div class="card-header">
                            <h6 class="mb-0">
                                <span class="badge badge-primary">${topicIndex + 1}</span>
                                ${topic.topic_name}
                                <span class="badge badge-secondary float-right">${words.length} words</span>
                            </h6>
                        </div>
                        <div class="card-body">
                `;
...
function escapeHtml(str) {
    ...
    function createTopicCard(topic, words, index, hasWords) {
        ...
        topicNumber.className = 'badge badge-primary mr-2';
        ...
        wordCount.className = 'badge badge-light text-dark mr-3';
        ...
        words.forEach((word, idx) => {
            ...
            let html = `
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div class="d-flex align-items-center">
                        <span class="badge badge-secondary mr-2">${idx + 1}</span>
                        <h6 class="mb-0 text-primary font-weight-bold">${escapeHtml(word.word)}</h6>
                    </div>
            `;
            
            if (word.part_of_speech) {
                html += `<span class="badge badge-info">${escapeHtml(word.part_of_speech)}</span>`;
            }
            ...
            if (word.example_sentence) {
                html += `
                    <div class="mb-2">
                        ...
                        <p class="mb-0 font-italic text-success">${escapeHtml(word.example_sentence)}</p>
                    </div>
                `;
            }
            ...
            if (word.syllables) additionalInfo.push({label: 'Syllables', value: word.syllables, class: 'badge badge-light'});
            if (word.difficulty_level) additionalInfo.push({label: 'Difficulty', value: word.difficulty_level, class: 'badge ' + (word.difficulty_level === 'Easy' ? 'badge-success' : word.difficulty_level === 'Medium' ? 'badge-warning' : 'badge-danger')});
