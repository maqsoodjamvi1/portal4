					...
					<div class="contact_form">
						...
						<div class="contact_form_container">
							<form action="post">
								...
								<textarea id="contact_form_message" class="text_field contact_form_message" name="message" placeholder="Message" required data-error="Please, write us a message."></textarea>
