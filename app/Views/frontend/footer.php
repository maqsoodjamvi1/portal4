		...
		<div class="row" style="margin-bottom:10px;margin-top:20px;">
			<div class="col-md-3" style="margin-bottom:10px;">
				<div class="media">
				  <div class="media-left">
					<a href="#">
					  <img class="media-object" src="<?=base_url('assets/png/001C.png'); ?>">
					</a>
				  </div>
				  <div class="media-body" style="font-size:12px;">
					<h4 class="media-heading" style="font-size:14px;font-weight:bold;">ADDRESS</h4>
			...
			<div class="col-md-3" style="margin-bottom:10px;">
				<div class="media">
				  <div class="media-left">
					<a href="#">
					  <img class="media-object" src="<?=base_url('assets/png/002C.png'); ?>">
					</a>
				  </div>
				  <div class="media-body" style="font-size:12px;">
					<h4 class="media-heading" style="font-size:14px;font-weight:bold;">PHONE SUPPORT</h4>
					+92-300-5340592	 </div>
				</div>
			</div>
			<div class="col-md-3" style="margin-bottom:10px;">
				<div class="media">
				  <div class="media-left">
					<a href="#">
					  <img class="media-object" src="<?=base_url('assets/png/003C.png'); ?>">
					</a>
				  </div>
				  <div class="media-body" style="font-size:12px;">
					<h4 class="media-heading" style="font-size:14px;font-weight:bold;">EMAIL SUPPORT</h4>
			...
			<div class="col-md-3" style="margin-bottom:10px;">
				<div class="media">
				  <div class="media-left">
					<a href="#">
					  <img class="media-object" src="<?=base_url('assets/png/004CA.png'); ?>">
					</a>
				  </div>
				  <div class="media-body" style="font-size:12px;">
					<h4 class="media-heading" style="font-size:14px;font-weight:bold;">SUPPORT TIME</h4>
