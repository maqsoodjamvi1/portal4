<link rel="stylesheet" href="<?php echo base_url();?>resource/bootstrap-switch/css/bootstrap3/bootstrap-switch.min.css" />
  <?= view('components/page_header', [
    'title' => 'Send Datesheet',
    'breadcrumbs' => [
        ['label' => 'Dashboard', 'url' => base_url('admin/dashboard')],
        ['label' => 'Send Datesheet', 'active' => true],
    ],
]) ?>
    ...
    <table class="table table-striped table-bordered table-hover" id="students-datatable" width="100%" style="font-size:12px;">
		<thead>
			<tr>
				...
				<!-- <th nowrap>Father Contacts </th>
  				<th nowrap>Mother Contacts </th> -->
                <th style="width: 80px;" nowrap>Whatsapp </th>
  			</tr>
		</thead>
		<tbody>
		</tbody>
...
$(function(){
	var table = $('#students-datatable').DataTable({
	  dom: 'Bfrtip',
		...
		"searching": false,
		ajax:{
			url:'<?php echo site_url('c=family_datesheet_whatsapp&m=data'); ?>',
			type:'post',
