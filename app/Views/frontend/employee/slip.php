...
<div id="wb_Text1" style="width: 100%;border: 1px dashed;text-align:center;z-index:0;border-radius: 5px;padding: 10px;margin: 0 auto;height: 120px;margin-top: 20px;margin-bottom: 20px;"><img src="<?=base_url('assets/imgs/tps.png'); ?>" class="img-responsive header_logo" style="max-height:100px;float: left;">
...
<img src="<?=base_url('assets/imgs/sen-logo.jpg'); ?>" class="img-responsive header_logo" style="max-height:100px;float: right;margin-top: -50px;">
</div>
