        ...
        <div class="col-lg-12">
         <div class="card card-primary card-outline card-tabs">
			...
			<ul class="nav nav-tabs">
				<li class="nav-item "><a class="nav-link active" href="<?= base_url('admin/assets') ?>">Assets</a></li>
				<li class="nav-item"><a class="nav-link" href="<?= base_url('admin/assets/add') ?>">Add Assets</a></li>
			</ul>
			<div class="card-body">
			<div class="col-lg-12">
              <table class="table table-striped table-bordered table-hover" id="users-datatable" width="100%">
					<thead>
						<tr>
							<th nowrap>#</th>
							<th nowrap>Assets Head</th>
							<th nowrap>Assets Title </th>
						  <th nowrap>Detail</th>
							<th nowrap>Amount</th>
							<th nowrap>Purchasing Date</th>
...
$(function(){
    ...
    $('#users-datatable thead tr:eq(1) th').each( function (i) {
 	...
 	var table = $('#users-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/assets/data'); ?>',
			type:'post',
			data:function(d){
		...
		columns:[
			...
			{data:'expense_date'},
			{
				...
				render:function(data, type, row){
					...
					html += '<a href="<?php echo '#/expenses?m=edit&id=';?>' + data + '" title="edit" class="btn btn-secondary btn-sm"><i class="fa fa-edit icon-pencil"></i></a>';
					html += '</div>';
					return html;
				}
			}
