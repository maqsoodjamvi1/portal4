    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Students Leaves</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
    ...
    <div class="col-lg-12">
      <div class="card card-primary card-outline card-tabs">
        ...
        <div class="tab-content">
		 <?php
			echo form_open( base_url('admin/students_leaves/save'), 'role="form" id="user-edit-form"');
...
function getstudents() {
		...
		var date = $('#date').val();
 	      ...
 	      $.ajax({
            url: '/admin/students_leaves/get_students_byclass',
            type: "POST",
...
$("#student_id").select2({
    ...
    tags: [],
    ajax: {
        url: '/admin/students_leaves/get_studentinfo', 
        dataType: 'json',
        type: "POST",
        quietMillis: 50,
        data: function (term) {
	...
	$('#user-edit-form').ajaxForm({
		...
		success:function(responseText, statusText, xhr, form){
			...
			if(json.success){
				...
				if($id == ''){
					?>
					location.href = '/admin/students_leaves/add';
					<?php
				}else{
					?>
					location.href = '/admin/students_leaves/add';
