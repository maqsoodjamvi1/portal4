...
<section class="content-header">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Students Contact List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="row">
      ...
      <ul class="nav nav-tabs">     
        <li  class="nav-item" ><a  class="nav-link <?php if($status == 1){ ?> active <?php } ?>" href="<?php echo base_url('admin/students_contact_list?status=1');?>">  Current</a></li>
    ...
    <table class="table table-striped table-bordered table-hover" id="students-datatable" width="100%" style="font-size:13px;">
					<thead>
						<tr style="vertical-align: middle;">
                            ...
                            <th nowrap>Emergency<br> Contacts </th>
                            <th nowrap>Whatsapp<br> Contacts </th>
						</tr>
					</thead>
					<tbody>
					</tbody>
...
$(function(){
    ...
    "order": [], //Initial no order.
		"pageLength": 200,
		 "searching": false,
		ajax:{
			url:'<?= base_url('admin/students_contact_list/data') . '?status=' . $_GET['status'] ?>',
			type:'post',
