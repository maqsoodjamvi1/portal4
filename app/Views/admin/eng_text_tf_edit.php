...
<?php
	if(isset($info)){
      ...
      $path1 = $info->path1;
			...
			$header = 'Add English Question T/F';
      $id = '';
      $date1 = '';
      $class_id = '';
      $subject_id = '';
    ...
    <div class="col-lg-12">
      <div class="card card-primary card-outline card-tabs">
        ...
        <ul class="nav nav-tabs">
          <li class="nav-item"><a  class="nav-link" href="<?php echo '#/eng_text_tf&topic_id='.$_GET['topic_id'];?>">English Question T/F</a></li>
          <?php if($id == ''){ ?>
          <li class="nav-item"><a class="nav-link active" href="<?php echo '#/eng_text_tf?m=add&topic_id='.$_GET['topic_id'];?>"><?php echo $header;?></a></li>
          <?php }else{ ?>
          <li class="nav-item"><a class="nav-link active" href="<?php echo '#/eng_text_tf?m=edit&topic_id='.$_GET['topic_id'];?>"><?php echo $header;?></a></li>
          <?php } ?>
        </ul>
     <div class="card-body">
      <?php
      echo form_open_multipart('c=eng_text_tf&m=save' ,'role="form" id="user-edit-form"');
