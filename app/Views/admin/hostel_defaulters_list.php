...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>
               Hostel Defaulters List
            </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('admin/dashboard') ?>">Dashboard</a></li>
              <li class="breadcrumb-item active">Hostel Defaulters List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <table class="table table-striped table-bordered table-hover" id="students-datatable" width="100%" style="font-size:13px;">
					<thead>
						<tr style="vertical-align: middle;">
                            ...
                            <th id="dynamicCol" nowrap><?php echo date('M Y'); ?></th>
                            <th nowrap>Previous Balance </th>
                            <th nowrap>Total </th>
						</tr>
					</thead>
					<tbody>
...
$(function(){
    var selectedFeeTypeTxt = 'Current Month';
	...
	var table = $('#students-datatable').DataTable({
	  dom: 'Bfrtip',
		...
		"pageLength": 200,
		 "searching": false,
		ajax:{
			url:'<?= base_url('admin/hostel_defaulters_list/data') . '?status=' . $_GET['status'] ?>',
			type:'post',
