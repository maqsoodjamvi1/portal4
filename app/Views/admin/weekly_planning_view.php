        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline card-tabs">
            <div class="card-header p-0 pt-1 border-bottom-0">
				...
				<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/weekly_planning_view') ?>">Weekly Planning View</a></li>
				<li class="nav-item"><a class="nav-link" href="<?= base_url('admin/weekly_planning_subject_view') ?>">Weekly Planning Subject View</a></li>
				...
				<div class="row">
					...
					<select class="form-control" name="term_id" id="term_id">
					    ...
					    <?php foreach ($terms_session_info as $value): ?>
					        <option value="<?= esc($value->term_session_id) ?>">
					            <?= esc($value->term_name) ?>
					        </option>
					    <?php endforeach; ?>
					</select>
			 ...
			 <script type="text/javascript">
			 	function submitterms(){
					...
					var term_week_id = $('#term_weeks').val(); 
					 $.ajax({
				            url: '/admin/weekly_planning_view/data',
				            type: "POST",
