    ...
    <div class="col-lg-12">
      <div class="card card-primary card-outline card-tabs">
        ...
        <ul class="nav nav-tabs">
          <li class="nav-item"><a class="nav-link" href="<?php echo '#/urdu_text_fb&topic_id='.$_GET['topic_id'];?>">Urdu Fill in The Blanks</a></li>
          <?php if($id == ''){ ?>
          <li class="nav-item"><a class="nav-link active
topic_id" href="<?php echo '#/urdu_text_fb?m=add&topic_id='.$_GET['topic_id'];?>"><?php echo $header;?></a></li>
          <?php }else{ ?>
          <li class="nav-item"><a class="nav-link" href="<?php echo '#/urdu_text_fb?m=edit&topic_id='.$_GET['topic_id'];?>"><?php echo $header;?></a></li>
          <?php } ?>
        </ul>
    <div class="card-body">
    <?php
			echo form_open_multipart('c=urdu_text_fb&m=save' ,'role="form" id="user-edit-form"');
		...
		<div class="row">
		   ...
		   <input type="hidden"  name="content_type_id" value="6" id="content_type_id">
		 </div>
		 <div class="col-lg-12">
