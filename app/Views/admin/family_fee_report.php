...
<?= view('components/page_header', [
    'title' => 'Family Fee Report',
    'icon' => 'fas fa-users',
    'breadcrumbs' => [
        ['label' => 'Dashboard', 'url' => base_url('admin/dashboard')],
        ['label' => 'Family Fee Report', 'active' => true],
    ],
]) ?>
    <!-- Main content -->	
    <section class="content">
      <div class="row">
		...
		<div class="col-lg-2"><input type="button" class="btn btn-primary btn-sm" value="View Report" id="viewReport"></div>
	</div>
...
$("#viewReport").click(function(){
   ...
   $.ajax({
        url:'<?php echo base_url('admin/family_fee_report/singleStudentFeedata'); ?>', 
        type: "POST",
