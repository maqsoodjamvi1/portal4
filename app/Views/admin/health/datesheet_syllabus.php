    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url('admin/datesheet') ?>">Datesheet</a></li>
...
(function () {
  ...
  function loadSyllabusGrid() {
    ...
    if (!eid) {
      $('#syllabusGrid').removeClass('border rounded bg-light').html('<div class="alert alert-danger mb-0">No active exam found for the current session.</div>');
      return;
    }
    ...
    $.post("<?= base_url('admin/datesheet/fetch-syllabus-grid') ?>", withCsrf({ cls_sec_id }))
      ...
      .fail(function () {
        $('#syllabusGrid').html('<div class="alert alert-danger mb-0">Failed to load syllabus grid.</div>');
      });
  }
