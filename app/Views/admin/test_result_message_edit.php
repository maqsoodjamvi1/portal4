...
<?= view('components/page_header', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => 'Result Message', 'active' => true],
    ],
]) ?>
...
<div class="col-lg-12">
  <div class="card card-primary card-outline card-tabs">
	...
	<ul class="nav nav-tabs">
		<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/test_result_message') ?>"><?php echo $header;?></a></li>
	</ul>
	<div class="card-body">
	<div class="tab-content">
	<?php
		echo form_open('c=test_result_message&m=save', 'role="form" id="user-edit-form"');
	...
	<div class="col-lg-2">	<a href="<?= base_url('admin/test_result_message') ?>" style="height: 33px;line-height: 17px;margin-top: 30px;"  onclick="submitFilter();" class="btn btn-primary">View</a></div>
...
<script type="text/javascript">
	 	function submitFilter(){
			...
			var fee_type_id = $('#fee_type').val();
			 ...
			 $.ajax({
            url: 'admin.php?c=test_result_message&m=data',
            type: "POST",
