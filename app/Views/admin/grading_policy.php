        ...
        <div class="col-lg-12">
         <div class="card card-primary card-outline card-tabs">
			...
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link" href="<?= base_url('admin/grades') ?>">Grades overview</a></li>
				<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/grading-policy') ?>">Policy list</a></li>
              ...
              <table class="table table-striped table-bordered table-hover" id="users-datatable" width="100%">
					<thead>
						<tr>
							<th nowrap>#</th>
							<th nowrap>Grade</th>
						  <th nowrap>Percentage From</th>
							<th nowrap>Percentage To</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
...
$(function(){
  ...
  var termsessionid = <?= json_encode(session('member_termsessionid')) ?>;
	...
	var table = $('#users-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/grading-policy/data'); ?>',
			type:'post',
			data:function(d){
