        ...
        <div class="card-body">
            ...
            <div class="card mb-4">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0"><i class="fas fa-graduation-cap me-2"></i> Academic Journey</h6>
                </div>
                <div class="card-body">
                    <div class="timeline">
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h6 class="timeline-title">
                                            ...
                                            <?php if ($index == 0): ?>
                                                <span class="badge text-bg-success ms-2">Current/Last Class</span>
                                            <?php endif; ?>
                                        </h6>
                                        <p class="text-muted">
            ...
            <div class="card mb-4">
                <div class="card-header bg-success text-white">
                    <h6 class="mb-0"><i class="fas fa-calendar-alt me-2"></i> Monthly Fee Payment Summary</h6>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php foreach ($monthly_fee_summary as $month): ?>
                                    <tr>
                                        ...
                                        <td class="text-end"><?= number_format($month->total_paid, 2) ?></td>
                                        <td class="text-end text-warning"><?= number_format($month->total_discount, 2) ?></td>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-header bg-primary text-white">
                            <h6 class="mb-0"><i class="fas fa-chart-pie me-2"></i> Fee Type Summary</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <thead class="table-light">
                                        <tr>
                                            <th>Fee Type</th>
                                            <th>Type</th>
                                            <th class="text-end">Total Paid (Rs.)</th>
                                            <th class="text-end">Discount (Rs.)</th>
                                            <th class="text-end">Net (Rs.)</th>
                                        ...
                                        <?php foreach ($fee_type_summary as $fee): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php else: ?>
                                                        <span class="badge text-bg-secondary">One-time</span>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-end"><?= number_format($fee->total_paid, 2) ?></td>
                                                <td class="text-end text-warning"><?= number_format($fee->total_discount, 2) ?></td>
                                                <td class="text-end text-success fw-bold">
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-header bg-warning text-dark">
                            <h6 class="mb-0"><i class="fas fa-chart-line me-2"></i> Annual Summary</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php foreach ($annual_summary as $year): ?>
                                            <tr>
                                                <td><?= $year->year ?></td>
                                                <td class="text-end"><?= number_format($year->total_paid, 2) ?></td>
                                                <td class="text-end text-warning"><?= number_format($year->total_discount, 2) ?></td>
                                                <td class="text-end text-success fw-bold">
            ...
            <div class="card">
                <div class="card-header bg-secondary text-white">
                    <h6 class="mb-0"><i class="fas fa-list-alt me-2"></i> Detailed Payment History</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="paymentTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-end">Discount (Rs.)</th>
                                    <th class="text-end">Net Paid (Rs.)</th>
                                    <th>Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($payment_history as $payment): ?>
                                    <tr>
                                        ...
                                        <td class="text-end text-warning"><?= number_format($payment->discount_amount, 2) ?></td>
                                        <td class="text-end text-success fw-bold">
                            ...
                            <tfoot class="table-light">
                                <tr class="fw-bold">
                                    ...
                                    <td class="text-end"><?= number_format(array_sum(array_column($payment_history, 'paid_amount')), 2) ?></td>
                                    <td class="text-end"><?= number_format(array_sum(array_column($payment_history, 'discount_amount')), 2) ?></td>
