...
<?= view('components/page_header', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => 'Quiz', 'url' => base_url('admin/quiz')],
		   ...
		   <div class="form-group">
			...
			<div class="form-group">
              <label>Start Date/Time</label>
                ...
                <input type="text" class="form-control datetimepicker-input" data-bs-target="#datepicker"  name="start_datetime" required value="<?php  echo $start_datetime; ?>"/>
            ...
            <div class="form-group">
              <label for="expire_datetime">Expire Date/Time</label>
                ...
                <input type="text" class="form-control datetimepicker-input" data-bs-target="#datepicker2" required name="expire_datetime" id="expire_datetime" value="<?php echo $expire_datetime;?>" />
