...
<?php
$classesIsNew = empty($classes_info->class_id ?? null);
$classesSetupBadge = $classesIsNew ? '<span class="badge text-bg-success">Step 4 of 10: System Configuration</span>' : '';
?>
<?php if ($classesIsNew): ?>
<audio autoplay controls hidden><source src="audio/Step6Classes.m4a" type="audio/mpeg"></audio>
<?php endif; ?>
<?= view('components/page_header', [
    'title' => $classesIsNew ? 'Add Class' : 'Edit Class',
    'icon' => 'fas fa-school',
    'actionsHtml' => $classesSetupBadge !== '' ? '<div class="text-sm-right">' . $classesSetupBadge . '</div>' : null,
    'breadcrumbs' => [
        ['label' => 'Dashboard', 'url' => base_url('admin/dashboard')],
        ['label' => 'Classes', 'url' => base_url('admin/classes')],
        ['label' => $classesIsNew ? 'Add' : 'Edit', 'active' => true],
    ],
]) ?>
...
<section class="content">
  <div class="card sms-card card-primary">
    ...
    <div class="card-body">
      <?= form_open(base_url('admin/classes/save'), ['id' => 'classes-edit-form', 'class' => 'needs-validation', 'novalidate' => 'novalidate']) ?>
