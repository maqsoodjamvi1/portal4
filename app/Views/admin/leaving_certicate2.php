      ...
      <div class="row">
        <div class="col-lg-12">
		 <div class="card card-primary card-outline card-tabs">
			...
			<li class="nav-item"><a class="nav-link" href="<?php echo '#/leaving_certificate2?m=download&regno='.$reg_no;?>">Download Certificate</a></li>
			<?php if($id == ''){ ?>
			<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/leaving_certificate2/download') ?>"><?php echo $header;?></a></li>
			<?php }else{ ?>
			<li class="nav-item"><a class="nav-link active" href="<?php echo '#/leaving_certificate2?m=edit&id=' . $id;?>"><?php echo $header;?></a></li>
			<?php } ?>
		</ul>
		<div class="card-body">	
		<div class="tab-content">
			<?php
			echo form_open('c=leaving_certificate2&m=save', 'role="form" id="user-edit-form"');
	...
	$('#user-edit-form').ajaxForm({
		...
		success:function(responseText, statusText, xhr, form){
			...
			if(json.success){
				...
				<?php if($id == ''){
					?>
					location.href = '#/leaving_certificate2/certificate2-<?php echo $reg_no;?>.html';
					<?php }else{ ?>
					location.href = '#/leaving_certificate2?m=download&regno=<?php echo $reg_no;?>';
					<?php } ?>
			}else{
