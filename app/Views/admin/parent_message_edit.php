...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>
           Fee Message To Parents
        </h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?= base_url('admin/dashboard') ?>">Dashboard</a></li>
          <li class="breadcrumb-item active">Fee Message To Parents</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
		   ...
		   Field.value += '{' + tag + '}';
			...
			<div class="form-group">
				...
				foreach ($detaulterArr as $key => $value) {
						echo "<label class='col-lg-3 text-left'><input type='checkbox' name='parent_id[]' checked value='".$value['parent_id']."'  > ".$value['f_name']." (Unpaid Fee: ".$value['unpaid_fee'].")</label>";
				}
				 ?>
			</div>
