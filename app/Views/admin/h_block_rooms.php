        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Block Rooms</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-lg-12">
         <div class="card card-primary card-outline card-tabs">
			...
			<ul class="nav nav-tabs">
					<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/h_block_rooms') ?>">Block Rooms</a></li>
					<li class="nav-item"><a class="nav-link" href="<?= base_url('admin/h_block_rooms/add') ?>">Add Block Rooms</a></li>
				</ul>
			<div class="card-body">
			<div class="col-lg-12">
...
$(function(){
	var table = $('#class-subjects-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/h_block_rooms/data'); ?>',
			type:'post',
			data:function(d){
