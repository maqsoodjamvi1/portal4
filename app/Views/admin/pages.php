          ...
          <div class="card card-primary card-outline card-tabs">
           <div class="card-header p-0 pt-1 border-bottom-0">
			<ul class="nav nav-tabs">
					<li class="nav-item"><a  class="nav-link active" href="<?= base_url('admin/pages') ?>">Pages</a></li>
					<li  class="nav-item"><a  class="nav-link" href="<?= base_url('admin/pages/add') ?>">Add Pages</a></li>
				</ul>
			<div class="card-body">
			<div class="col-lg-12">
...
$(function(){
	var table = $('#users-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/pages/data'); ?>',
			type:'post',
			data:function(d){
		...
		columns:[
			...
			{data:'content'},
			{
				...
				render:function(data, type, row){
					...
					html += '<a href="<?php echo '#/pages?m=edit&id=';?>' + data + '" title="edit" class="btn btn-secondary btn-sm"><i class="far fa-edit"></i></a>';
					html += '</div>';
					return html;
				}
			}
