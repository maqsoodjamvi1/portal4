        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline card-tabs">
			...
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/custom_campus') ?>">Campus</a></li>
				<li class="nav-item"><a class="nav-link" href="<?= base_url('admin/custom_campus/add') ?>">Add Campus</a></li>
			</ul>
		<div class="card-body">
		<div class="col-lg-12">
		...
		columns:[
			...
			{data:'location'},
			{
				...
				render:function(data, type, row){
					...
					// html += '<a href="<?php //echo '#/campus?m=edit&id=';?>' + data + '" title="edit" class="btn btn-secondary btn-sm"><i class="fa fa-edit icon-pencil"></i></a>';
  			// 		html += '</div>';
					return html;
				}
			}
