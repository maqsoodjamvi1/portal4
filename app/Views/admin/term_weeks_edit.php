...
?>
<?php
$termWeekSetupBadge = empty($termweeks_info->term_weeks_id)
    ? '<span class="badge text-bg-success">Step 5 of 12: System Configuration</span>'
    : '';
?>
<?= view('components/page_header', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => 'Term Weeks', 'url' => base_url('admin/term_weeks')],
        ['label' => empty($termweeks_info->term_weeks_id) ? 'Add' : 'Edit', 'active' => true],
    ],
    'actionsHtml' => $termWeekSetupBadge,
]) ?>
    <!-- Main content -->
