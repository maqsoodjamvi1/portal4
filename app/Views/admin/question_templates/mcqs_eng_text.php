<table id="myTable" class=" table order-list">
    ...
    <tbody>
        <tr>
         ...
         <td  style="border: 4px solid blue;border-left: 0 none !important;border-right: 0 none !important;"> <textarea class="form-control editor" name="hint_text0" placeholder="Hint" rows="3" id="hint_text"></textarea>
