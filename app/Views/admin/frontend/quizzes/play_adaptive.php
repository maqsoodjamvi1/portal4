...
<section class="quiz-topbar">
  <div class="d-flex align-items-center justify-content-between flex-wrap flex-md-nowrap">
    <div class="mb-1 mb-md-0">
      ...
      <?php if ($isAdaptive): ?>
        <div class="quiz-meta">
          <span class="badge text-bg-<?=  $levelDifficulty === 'easy' ? 'success' : ($levelDifficulty === 'hard' ? 'danger' : 'warning') ?> me-2">
...
async function submitLevel() {
  ...
  if (submitBtn) {
    ...
    submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-1"></i> Evaluating...';
...
function showLevelResult(result) {
  ...
  if (passed) {
    ...
    actionsEl.innerHTML = `
      <button type="button" class="btn btn-warning btn-lg me-2" onclick="retryLevel()">
