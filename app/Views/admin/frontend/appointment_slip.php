...
<?php if($adRegistrationInfo->class_id == 1){ ?>
	...
	<img src="<?=base_url('assets/imgs/ma.jpg'); ?>" class="img-fluid header_logo" style="width:100%;float: left;">
<?php }else{ ?>
	<div class="ma"  style="width: 100%;float: left;text-align: center;border-bottom: 0;line-height: 30px;border-end: 0;border-top: 0;border-start: 0;">Montessori Alpha</div>
<?php } ?>
</td>
<td  style="padding: 0px;width: 25%;print-color-adjust: exact;border: 1px solid #000;">	
	<?php if($adRegistrationInfo->class_id == 2){ ?>
		<!-- color:#fff !important;background-color: #00A85A; -->
		<img src="<?=base_url('assets/imgs/mj.jpg'); ?>" class="img-fluid header_logo" style="width:100%;max-height:100px;float: left;">
	<?php }else{ ?>
	<div style="width: 100%;float: left;text-align: center;padding: 0px;line-height: 30px;border-bottom: 0;border-top: 0;border-end: 0;">Montessori Junior</div>
	<?php } ?>
</td>
<td  style="padding: 0px;width: 25%;print-color-adjust: exact;border: 1px solid #000;">
	<?php if($adRegistrationInfo->class_id == 3){ ?>
		<!-- color:#fff !important;background-color: #3C4099; -->
		<img src="<?=base_url('assets/imgs/ms.jpg'); ?>" class="img-fluid header_logo" style="width:100%;max-height:100px;float: left;">
	<?php }else{ ?> 
	<div style="width: 100%;float: left;text-align: center;line-height: 30px;border-bottom: 0;border-top: 0;border-end: 0;">Montessori Advance</div>
	<?php } ?>
</td>
</tr>	
<tr>
