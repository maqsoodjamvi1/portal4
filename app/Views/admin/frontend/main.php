            ...
            <form  name="frm_new" id="frm_new" action="demo_process.php" method="post">
             <input type="hidden" name="ACT" value="NEW_REGISTER">
              ...
              <div class="form-group" style="margin-bottom:5px;"> 
                <div class="col-12" style="margin-bottom:5px;"><input name="school_name" type="text" class="form-control txt_reg" id="school_name" size="40" placeholder="Your School Name" ></div>
              </div>
			  <div class="form-group" style="margin-bottom:5px;">
			  	<div class="col-6" style="margin-bottom:5px;"><input name="first_name" type="text" class="form-control txt_reg" id="first_name" size="40" placeholder="First Name" ></div>
				<div class="col-6" style="margin-bottom:5px;"><input name="last_name" type="text" class="form-control txt_reg" id="last_name" size="40" placeholder="Last Name" ></div>
              </div>
              <div class="form-group" style="margin-bottom:5px;"> 
                <div class="col-12" style="margin-bottom:5px;"><input name="phone_no" type="text" class="form-control txt_reg" id="phone_no" size="40" placeholder="Your Valid Phone Number" ></div>
              </div>
			  <div class="form-group" style="margin-bottom:5px;"> 
