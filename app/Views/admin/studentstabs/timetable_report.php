            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check form-check mb-2">
                            ...
                            <label for="modeClass" class="form-check-label">Class-wise</label>
                        ...
                        <div class="form-check form-check">
                            ...
                            <label for="modeTeacher" class="form-check-label">Teacher-wise</label>
                    ...
                    <div class="col-md-1 d-flex align-items-end">
                        ...
                        <button id="btnLoadReport" type="button" class="btn btn-primary w-100">Load</button>
                ...
                <div class="row mt-3 align-items-center">
                    ...
                    <div class="col-md-auto">
                        ...
                        <div class="form-check form-check mb-2 mb-md-0">

                            <input type="checkbox" class="form-check-input" id="chkShowSlotTime" value="1">

                            <label class="form-check-label" for="chkShowSlotTime">Show slot times</label>
                    ...
                    <div class="col-md-auto">
                        ...
                        <div class="form-check form-check mb-2 mb-md-0">
                            ...
                            <label class="form-check-label" for="chkDetailInline" id="lblDetailInline">Show teacher with subject (same line)</label>
                ...
                <div class="row mt-2 align-items-center">
                    <div class="col-md-auto">
                        <div class="form-check form-check mb-2 mb-md-0">
                            <input type="checkbox" class="form-check-input" id="chkAdjustMode" value="1">
                            <label class="form-check-label" for="chkAdjustMode">Manual adjustment mode</label>
                        </div>
                        <small class="text-muted d-block">Class-wise, single section only — place unplaced subjects into the grid.</small>
                    </div>
                </div>
                ...
                <div class="row mt-2 align-items-center flex-wrap">
                    ...
                    <div class="col-md d-flex flex-wrap justify-content-md-end">
                        <button id="btnPrintReport" type="button" class="btn btn-secondary btn-sm me-2 mb-2 mb-md-0" disabled title="Print A4 landscape">
                            <i class="fas fa-print"></i> Print report
                        </button>
                        <button id="btnExportPdf" type="button" class="btn btn-outline-danger btn-sm me-2 mb-2 mb-md-0" disabled>
...
$(function () {
    (function applyReportQueryParams() {
        ...
        if (params.get('adjust') === '1') {
            ...
            $('#chkAdjustMode').prop('checked', true);
        }
    })();
    ...
    $('input[name="reportMode"]').on('change', function () {
        ...
        if ($('input[name="reportMode"]:checked').val() !== 'class') {
            $('#chkAdjustMode').prop('checked', false);
        }
    });
    ...
    function isAdjustMode() {
        return $('#chkAdjustMode').is(':checked') && $('input[name="reportMode"]:checked').val() === 'class';
    }
    ...
    function renderAdjustPanel() {
        ...
        if (!data || !data.success) {
            ...
            $('#reportContainer').addClass('d-none').empty();
            return;
        }
        ...
        const html = '<div class="card card-outline card-warning no-print">' +
            '<div class="card-header d-flex justify-content-between align-items-center flex-wrap">' +
            '<h3 class="card-title mb-2 mb-md-0">Adjust Timetable: ' + escapeHtml(data.title || '') + '</h3>' +
            '<div class="d-flex align-items-center flex-wrap">' +
            '<button type="button" class="btn btn-sm btn-outline-secondary mb-2 mb-md-0" id="btnRefreshAdjust"><i class="fas fa-sync"></i> Refresh</button>' +
            '</div></div>' +
            '<div class="card-body">' +
            '<div class="alert alert-light border small mb-3">' +
    ...
    function reloadAdjustData() {
        const cid = Number($('#clsSecId').val());
        if (!cid) {
            return;
        }
    ...
    $('#btnLoadReport').on('click', function () {
        ...
        if (mode === 'class') {
            ...
            if (isAdjustMode()) {
                if (payload.cls_sec_id === 'all') {
                    toastr.warning('Manual adjustment works for one class section at a time. Please select a single section.');
                    return;
                }
                reloadAdjustData();
                return;
