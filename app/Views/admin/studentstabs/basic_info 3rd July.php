...
<div class="col-md-12 mt-3">
    <div class="form-check">
        <input class="form-check-input" type="checkbox" id="edit_parent_info">
...
<!-- Add spinner icon near CNIC field -->
<label for="father_cnic" class="form-label required">Father CNIC</label>
<div class="input-group">
    <span class="input-group-text"><i class="fas fa-id-card"></i></span>
    <input type="text" required class="form-control form-control-sm cnic-mask" name="father_cnic" id="father_cnic" value="<?= esc($father_cnic) ?>" placeholder="XXXXX-XXXXXXX-X">
...
$(document).ready(function() {
    // Function to enable/disable parent fields
    ...
    $('#father_cnic').on('blur', function() {
        ...
        console.log('Type of Campus ID:', typeof campus_id);
        ...
        if (!campus_id) {
            toastr.error('Campus ID is missing in session');
            return;
        }
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.exists) {
                    ...
                    toastr.info('Parent information loaded. Check "Edit Parent Information" to modify.');
                } else {
            ...
            error: function(xhr, status, error) {
                ...
                try {
                    ...
                    toastr.error(response.error || 'Error checking parent information in try');
                } catch (e) {
                    toastr.error('Error checking parent information in catch');
                }
            }
        });
    });
...
document.querySelectorAll('.parent-field').forEach(field => {
    field.classList.add('parent-field');
});
</script>
