...
<section class="content-header">
  <h1>  Audio Lecture  <small></small> </h1>
  <ol class="breadcrumb">
  <li><a href="<?= base_url('admin/dashboard') ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
  <li class="active"> Audio Lecture </li>
  </ol>
</section>
<!-- Main content -->
    ...
    <div class="col-xs-12">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li><a href="<?= base_url('admin/audio_lecture') ?>">Audio Lecture</a></li>
          <?php if($id == ''){ ?>
          <li class="active"><a href="<?= base_url('admin/audio_lecture/add') ?>"><?php echo $header;?></a></li>
          <?php }else{ ?>
          <li class="active"><a href="<?php echo '#/audio_lecture?m=edit&id=' . $id;?>"><?php echo $header;?></a></li>
          <?php } ?>
        </ul>
  <div class="tab-content">
  <?php
	echo form_open_multipart('c=audio_lecture&m=save', 'role="form" id="audio-lecture-edit-form"');
	...
	<div class="row">
		<div class="col-lg-12">
		   ...
		   <div class="col-lg-2">
		    <div class="form-group">
              ...
              <select class="form-control" name="topic_skill_id" id="topic_skill_id">
               ...
               <input type="hidden"  name="content_type_id" value="13" id="content_type_id">
             </div>
		   </div>	   
		  </div>
		  </div>
		  ...
		  <table id="myTable" class=" table order-list">
		    <thead>
		        <tr>
			       <td><div style="text-align: center;font-weight: bold;">Audio Reference</div></td>
		        </tr>
		    </thead>
		    <tbody>
           <tr>
			  ...
			  <input type="input" name="document_url0" class="form-control">
        <small>Insert Audio URL</small>
		      </td>
		  </tr>	
		  </tbody>
		  <tfoot>
	...
	$('#user-edit-form').ajaxForm({
		...
		success:function(responseText, statusText, xhr, form){
			...
			if(json.success){
				...
				if($id == ''){
					?>
					location.href = '#/audio_lecture';
					<?php
				}else{
					?>
					location.href = '#/audio_lecture?m=edit&id=<?php echo $id;?>&after=edit';
					<?php
				}
				?>
			}else{
