...
<link rel="stylesheet" href="<?php echo base_url();?>resource/bootstrap-switch/css/bootstrap3/bootstrap-switch.min.css" />
    ...
    'title' => 'Sibling Fee History',
    'breadcrumbs' => [
        ['label' => 'Dashboard', 'url' => base_url('admin/dashboard')],
        ['label' => 'Sibling Fee History', 'active' => true],
    ],
]) ?>
    ...
    <section class="content">
      <div class="row">
		...
		<strong>Parent Name: </strong>	<p><?php echo $parentsinfo->f_name; ?>	</p>
		<table class="table" style="width:50%;">
		<tr><th>Student Name</th><th>Fee Details</th></tr>
		<?php foreach($studentsinfo as $student){
		  echo "<tr><td>".$student->first_name." ".$student->last_name."</td><td> <a class='btn btn-primary' target='_blank' href='admin.php#/fee_history?student_id=".$student->student_id."'>History</a><td> </tr>";
		} ?>
		</table>
...
$(function(){
	var table = $('#users-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo site_url('c=fee_sibling_history&m=data&parent_id='.$parent_id);?>',
			type:'post',
			data:function(d){
