    ...
    <div class="col-lg-12">
      <div class="card card-primary card-outline card-tabs">
        ...
        <ul class="nav nav-tabs">
          <li class="nav-item"><a class="nav-link" href="<?= base_url('admin/worksheet_meta_info') ?>">WorkSheet Meta Info</a></li>
          <?php if($id == ''){ ?>
          <li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/worksheet/add') ?>"><?php echo $header;?></a></li>
          <?php }else{ ?>
          <li class="nav-item"><a class="nav-item" href="<?php echo '#/worksheet_meta_info?m=edit&id=' . $id;?>"><?php echo $header;?></a></li>
          <?php } ?>
        </ul>
    <div class="card-body">
    <?php
        echo form_open_multipart('c=worksheet_meta_info&m=save', 'role="form" id="user-edit-form"');
       ...
       <div class="col-lg-4">
		  ...
		  <table id="myTable" class=" table order-list">
		    <thead>
		    <tr>
			 <td style="width: 25%;" ><div style="text-align: center;font-weight: bold;">Meta Title</div></td>
             <td><div style="text-align: center;font-weight: bold;"> Meta Keywords</div></td>
             <td><div style="text-align: center;font-weight: bold;">Meta Description</div></td>
		    </tr>
		    </thead>
		    <tbody>
  <?php 
...
$(document).ready(function () {
 $("#topic_id").change(function(){
    var topic_id = $('#topic_id').val();
	  $.ajax({
        url: 'admin.php?c=worksheet_meta_info&m=selectWorksheetsByID',
        type: "POST",
