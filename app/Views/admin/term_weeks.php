        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Terms Weeks</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline card-tabs">
			...
			<ul class="nav nav-tabs">
					<li class="nav-item"><a class="nav-link active" href="<?php echo base_url('admin/term_weeks');?>">Term Weeks</a></li>
					<li class="nav-item"><a  class="nav-link" href="<?php echo base_url('admin/term_weeks/add');?>">Add Term Week</a></li>
				</ul>
			<div class="card-body">
			<div class="col-lg-12">
              <table class="table table-striped table-bordered table-hover" id="users-datatable" width="100%">
					<thead>
						<tr>
							<th nowrap>Term Session</th>
						    <th nowrap>Week Name</th>
							<th nowrap>Start Date</th>
							<th nowrap>End Date</th>
							<th nowrap>Week Type</th>
							<th style="width: 250px;" nowrap>Detail</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
...
$(function(){
	...
	var table = $('#users-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/term_weeks/data');?>',
			type:'post',
			data:function(d){
