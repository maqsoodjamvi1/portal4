    ...
    <div class="col-xs-12">
      ...
      <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
          ...
          <li><a href="<?= base_url('admin/lesson_plan') ?>">Lesson Plan</a></li>

          <?php if($id == ''){ ?>

          <li class="active"><a href="<?= base_url('admin/lesson_plan/add') ?>"><?php echo $header;?></a></li>

          <?php }else{ ?>

          <li class="active"><a href="<?php echo '#/lesson_plan?m=edit&id=' . $id;?>"><?php echo $header;?></a></li>
        ...
        <div class="tab-content">
          ...
          <?php
			...
			echo form_open_multipart('c=lesson_plan&m=save', 'role="form" id="user-edit-form"');
		   ...
		   <div class="col-lg-2">
		    ...
		    <div class="form-group">
              ...
              <select class="form-control" name="topic_skill_id" id="topic_skill_id">
               ...
               <input type="hidden"  name="content_type_id" value="11" id="content_type_id">
		  ...
		  <table id="myTable" class=" table order-list">
		    ...
		    <thead>
		        ...
		        <tr>
			       ...
			       <td><div style="text-align: center;font-weight: bold;">LessonPlan Reference</div></td>
...
$(document).ready(function () {
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td style="border: 4px solid blue; border-right: 0 none !important;"><input type="hidden" name="questioncount[]" value="1" />  <input type="file" name="document_url'+ counter +'" class="form-control"><small>Select Worksheet</small></td>';
		...
		success:function(responseText, statusText, xhr, form){
			...
			if(json.success){
				...
				if($id == ''){
					...
					location.href = '#/question_bank_gk';
