...
$(document).ready(function () {
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td style="border: 4px solid blue; border-end: 0 none !important;"><input type="hidden" name="questioncount[]" value="1" />  <input type="file" name="document_url'+ counter +'" class="form-control"><small>Select Worksheet</small></td>';
