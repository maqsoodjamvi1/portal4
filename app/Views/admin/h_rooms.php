           ...
           <div class="card card-primary card-outline card-tabs">
          	<div class="card-header p-0 pt-1 border-bottom-0">
				<ul class="nav nav-tabs">
					<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/h_rooms') ?>">Rooms</a></li>
					<li class="nav-item"><a  class="nav-link" href="<?= base_url('admin/h_rooms/add') ?>">Add Rooms</a></li>
				</ul>
			<div class="card-body">
			<div class="col-lg-12">
...
$(function(){
	var table = $('#classes-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/h_rooms/data'); ?>',
			type:'post',
			data:function(d){
