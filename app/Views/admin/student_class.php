        ...
        <div class="col-lg-12">
          ...
          <div class="card-header p-0 pt-1 border-bottom-0">
			<ul class="nav nav-tabs">
				...
				<li  class="nav-item"><a  class="nav-link" href="<?= base_url('admin/student_class/add') ?>">Add Student Class</a></li>
			</ul>
		<div class="card-body">
		<div class="col-lg-12">
...
$(function(){
    ...
    serverSide: true,
		ajax:{
			url:'<?php echo base_url('admin/student_class/data'); ?>',
			type:'POST',
			data:function(d){
