		...
		<div class="card-body">
            ...
            <table class="table table-striped table-bordered table-hover" id="classdairy-datatable" width="100%">
				<thead>
					<tr>
						<th  nowrap>#</th>
						<th style="width:50px;" nowrap>Class</th>
						<th style="width:50px;" nowrap>Week Name</th>
         				<th nowrap>Objective</th>
        				<th style="width:50px;" nowrap>Operation</th>
					</tr>
				</thead>
			<tbody>
			</tbody>
...
$(function(){
	...
	var table = $('#classdairy-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/weekly_planning/data'); ?>',
			type:'post',
			data:function(d){
			...
			{ 
				...
				render:function(data, type, row){
					...
					html += '<div class="btn-group">';
						  html += '<a href="<?php echo '/admin/classdairy/edit?id=';?>' + data + '" title="edit" class="btn btn-secondary btn-sm"><i class="fa fa-edit icon-pencil"></i></a>';
						   if(row.issys == '1'){
						  }else{
