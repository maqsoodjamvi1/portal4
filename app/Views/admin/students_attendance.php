...
<link rel="stylesheet" href="<?php echo base_url();?>resource/bootstrap-switch/css/bootstrap3/bootstrap-switch.min.css" />
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Students Attdendance</li>
      </ol>
    </section>
    <!-- Main content -->
			...
			{data:'detail'},
			{
				...
				render:function(data, type, row){
					...
					html += '<div class="btn-group">';
						  html += '<a href="<?php echo '#/sections?m=edit&id=';?>' + data + '" title="edit" class="btn btn-default btn-xs"><i class="fa fa-pencil icon-pencil"></i></a>';
						  if(row.issys == '1'){
