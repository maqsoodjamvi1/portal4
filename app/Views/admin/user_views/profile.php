<div class="row">
    <div class="col-md-6">
        <strong><i class="fas fa-id-card me-1"></i> CNIC</strong>
        <p class="text-muted"><?= esc($user->cnic) ?></p>
        
        <strong><i class="fas fa-user me-1"></i> Father's Name</strong>
        <p class="text-muted"><?= esc($user->f_name) ?></p>
        
        <strong><i class="fas fa-calendar me-1"></i> Date of Birth</strong>
    ...
    <div class="col-md-6">
        <strong><i class="fas fa-calendar-check me-1"></i> Joining Date</strong>
        <p class="text-muted"><?= esc($user->joining_date) ?></p>
        
        <strong><i class="fas fa-graduation-cap me-1"></i> Qualification</strong>
        ...
        <strong><i class="fas fa-map-marker me-1"></i> Address</strong>
