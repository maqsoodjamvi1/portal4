        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline card-tabs">
			...
			<ul class="nav nav-tabs">
					<li class="nav-item">
						<a class="nav-link active" href="<?= base_url('admin/a_subjects') ?>">Subjects</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="<?= base_url('admin/a_subjects/add') ?>">Add Subject</a>
					</li>
				</ul>
			<div class="card-body">
			<div class="col-lg-12">
...
$(function(){
	var table = $('#users-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/a_subjects/data'); ?>',
			type:'post',
			data:function(d){
			...
			{data:'subject_short_name'},
			{
				...
				render:function(data, type, row){
					...
					html += '<div class="btn-group">';
						  html += '<a href="<?php echo '#/a_subjects?m=add&id=';?>' + data + '" title="edit" class="btn btn-secondary btn-sm"><i class="fa fa-edit icon-pencil"></i></a>';
