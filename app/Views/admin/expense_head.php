...
<?= view('components/page_header', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => 'Expense Head', 'active' => true],
    ],
]) ?>
    <!-- Main content -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card-header p-0 pt-1 border-bottom-0">
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a class="nav-link active" href="<?= base_url('admin/expense_head') ?>">Expense Head</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url('admin/expense_head/add') ?>">Add Expense Head</a>
				</li>
			</ul>
			<div class="card-body">
			<div class="col-lg-12">
...
$(function(){
	var table = $('#users-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/expense_head/data'); ?>',
			type:'post',
			data:function(d){
