        ...
        <div class="col-lg-12">
          ...
          <div class="card-header p-0 pt-1 border-bottom-0">
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link" href="<?= base_url('admin/expense_head') ?>">Expense Head</a></li>
				<?php if($id == ''){ ?>
					<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/expense_head/add') ?>"><?php echo $header;?></a></li>
				<?php }else{ ?>
					<li class="nav-item"><a class="nav-link active" href="<?php echo '#/expense_head?m=edit&id=' . $id;?>"><?php echo $header;?></a></li>
				<?php } ?>
			</ul>
			<div class="card-body">
			<div class="tab-content">
			<?php
			echo form_open('c=expense_head&m=save', 'role="form" id="user-edit-form"');
			...
			<div class="table-responsive">  
                ...
                <thead>
			        <tr>
			            <td><label for="fee_type_name">Expense Head</label></td>
				...
				foreach ($info as $key => $value) { //print_r($value); ?>
                    <tr>  
                        <td>
                        	...
                        	<input type="hidden" name="id<?php echo $i; ?>" value="<?php echo $value->exp_head_id; ?>">
	...
	$('#user-edit-form').ajaxForm({
		...
		success:function(responseText, statusText, xhr, form){
			...
			<?php
				if($id == ''){
					?>
				location.href = '#/expense_head';
			<?php
				}else{
			?>
			location.href = '#/expense_head?m=edit&id=<?php echo $id;?>&after=edit';
			<?php } ?>
