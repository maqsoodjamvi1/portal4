...
<div class="col-lg-12">
  <div class="card card-primary card-outline card-tabs">
	...
	<ul class="nav nav-tabs">
		<?php if($id == ''){ ?>
		<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/defaulter_message') ?>"><?php echo $header;?></a></li>
		<li class="nav-item"><a class="nav-link" href="<?= base_url('admin/defaulter_message/parent_sms') ?>">Unique sms to parent</a></li>
		<?php }else{ ?>
