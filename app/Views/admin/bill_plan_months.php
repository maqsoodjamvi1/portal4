        ...
        <div class="col-lg-12">
         <div class="card card-primary card-outline card-tabs">
			...
			<ul class="nav nav-tabs">
					<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/bill_plan_months') ?>">Bill Plan Months</a></li>
					<li class="nav-item"><a class="nav-link" href="<?= base_url('admin/bill_plan_months/add') ?>">Add Bill Plan Months</a></li>
				</ul>
			<div class="card-body">
			<div class="col-lg-12">
...
$(function(){
	var table = $('#class-subjects-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/bill_plan_months/data'); ?>',
			type:'post',
			data:function(d){
