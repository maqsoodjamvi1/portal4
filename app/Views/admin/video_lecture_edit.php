    ...
    <div class="col-12">
      ...
      <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
          ...
          <li><a href="<?= base_url('admin/video_lecture') ?>">Video Lecture</a></li>

          <?php if($id == ''){ ?>

          <li class="active"><a href="<?= base_url('admin/video_lecture/add') ?>"><?php echo $header;?></a></li>

          <?php }else{ ?>

          <li class="active"><a href="<?php echo '#/video_lecture?m=edit&id=' . $id;?>"><?php echo $header;?></a></li>
        ...
        <div class="tab-content">
          ...
          <?php
			...
			echo form_open_multipart('c=video_lecture&m=save', 'role="form" id="user-edit-form"');
		   ...
		   <div class="col-lg-2">
		    ...
		    <div class="form-group">
              ...
              <select class="form-control" name="topic_skill_id" id="topic_skill_id">
               ...
               <input type="hidden"  name="content_type_id" value="12" id="content_type_id">
		  ...
		  <table id="myTable" class=" table order-list">
		    ...
		    <thead>
		        ...
		        <tr>
			       ...
			       <td><div style="text-align: center;font-weight: bold;">Video Reference</div></td>
