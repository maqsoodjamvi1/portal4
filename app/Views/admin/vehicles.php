           ...
           <div class="card card-primary card-outline card-tabs">
          	<div class="card-header p-0 pt-1 border-bottom-0">
				<ul class="nav nav-tabs">
					<li class="nav-item"><a class="nav-link active" href="<?= base_url('admin/vehicles') ?>">Vehicles</a></li>
					<li class="nav-item"><a  class="nav-link" href="<?= base_url('admin/vehicles/add') ?>">Add Vehicles</a></li>
				</ul>
			<div class="card-body">
			<div class="col-lg-12">
              <table class="table table-striped table-bordered table-hover" id="classes-datatable" width="100%">
					<thead>
						<tr>
							<th nowrap>#</th>
							<th nowrap>Reg No</th>
							<th nowrap>Vehicle Code</th>
							<th nowrap>Route</th>
							<th nowrap>Route Fare</th>
						</tr>
					</thead>
					<tbody>
...
$(function(){
	var table = $('#classes-datatable').DataTable({
		...
		ajax:{
			url:'<?php echo base_url('admin/vehicles/data'); ?>',
			type:'post',
			data:function(d){
