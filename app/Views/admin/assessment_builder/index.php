...
$canQuiz = $canQuiz ?? true;

$canPaper = $canPaper ?? true;
...
<?= view('components/page_header', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => 'Assessment Builder', 'active' => true],
...
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-12">
      ...
      <?= view('admin/assessment_builder/partials/choose_questions', ['boardPublishers' => $boardPublishers ?? []]) ?>

      <?php if ($canQuiz || $canPaper): ?>
      <div class="card card-outline card-primary mb-3" id="abSavePanel">
        <div class="card-header py-2"><h3 class="card-title mb-0">2. Save</h3></div>
        ...
        <div class="card-body pb-2">
          ...
          <div class="row">
            <?php if ($canQuiz): ?>
            <div class="<?= $canPaper ? 'col-lg-6' : 'col-12' ?> mb-3 mb-lg-0">
              <?= view('admin/assessment_builder/partials/quiz_form', get_defined_vars()) ?>
            </div>
            <?php endif; ?>
            <?php if ($canPaper): ?>
            <div class="<?= $canQuiz ? 'col-lg-6' : 'col-12' ?>">
              <?= view('admin/assessment_builder/partials/paper_steps', get_defined_vars()) ?>
            </div>
            <?php endif; ?>
          </div>
          ...
          <div class="border-top pt-3 mt-2">
            ...
            <button type="button" class="btn btn-sm btn-outline-secondary mb-2" data-bs-toggle="collapse"
              ...
              <i class="fas fa-history me-1"></i> Previous items
            ...
            <div id="existingItemsCollapse" class="collapse">
              ...
              <div class="row">
                ...
                <div class="<?= $canPaper ? 'col-lg-6' : 'col-12' ?> mb-2 mb-lg-0">

                  <div class="small fw-bold text-muted mb-1">Quizzes</div>
                ...
                <div class="<?= $canQuiz ? 'col-lg-6' : 'col-12' ?>">
                  ...
                  <div class="small fw-bold text-muted mb-1">Question papers</div>

                  <div id="existingPapersWrap" class="ab-existing-wrap">

                    <span class="text-muted small">Select topics.</span>
...
<style>
  ...
  .qp-count-field.qp-marks-inactive .qp-type-count {
    opacity: 0.55;
  }
  .qp-marks-cell .qp-marks-input:disabled {
    background: #f1f3f5;
  }
...
<?= view('admin/assessment_builder/partials/paper_scripts') ?>
