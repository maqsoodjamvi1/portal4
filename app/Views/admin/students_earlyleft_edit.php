...
<?= view('components/page_header', [
    'title' => 'Students Early Left',
    'breadcrumbs' => [
        ['label' => 'Dashboard', 'url' => base_url('admin/dashboard')],
        ['label' => 'Students Early Left', 'active' => true],
    ],
]) ?>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card card-primary card-outline card-tabs">
		...
		<?php
		echo form_open( base_url('students_earlyleft/save') , 'role="form" id="user-edit-form"');
...
function getstudents() {
		...
		var date = $('#date').val();
 	      ...
 	      $.ajax({
            url: '/admin/students_earlyleft/get_students_byclass',
            type: "POST",
...
$("#student_id").select2({
    ...
    tags: [],
    ajax: {
        url: '/admin/students_earlyleft/get_studentinfo',
        dataType: 'json',
        type: "POST",
        quietMillis: 50,
        data: function (term) {
	...
	$('#user-edit-form').ajaxForm({
      ...
      $('#submitBtn').prop('disabled', false);
			...
			if(json.success){
				...
				if($id == ''){
					?>
					location.href = '/admin/students_earlyleft/add';
					<?php
				}else{
					?>
					location.href = '/admin/students_earlyleft/add';
