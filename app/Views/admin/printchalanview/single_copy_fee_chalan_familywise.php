                ...
                <div class="card-header p-0 pt-1 border-bottom-0">
                    <div class="card-body">
                        ...
                        <?php foreach ($data as  $key => $student_info) { ?>
                                    ...
                                    <div style="">
                                        ...
                                        <div class="chalanwrapper">
                                            ...
                                            <div class="feeinfo">
                                                ...
                                                <div class="chalanrows" style="line-height: 17px; font-size: 11px;">
                            ...
                            <?php if(($key + 1) % 3 == 0){ ?><div style="clear:both;page-break-after: always;"></div><?php } ?>
                            <?php } ?>
                        </div>
