...
<section class="content">
  <div class="row">
    <div class="col-lg-12">
      <form action="<?= current_url() ?>" role="form" id="user-edit-form" method="get">
        <div class="row">
        ...
        <div class="card-body">
          <?php if (!empty($data)): ?>
            <?php foreach ($data as $key => $student_info): ?>
              <?= view('admin/partials/fee_chalan_single_without_discount.php', compact('student_info', 'show_line1', 'footer_line1', 'show_line2', 'footer_line2')) ?>
