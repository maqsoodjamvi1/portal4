...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    ...
    <!-- JQVMap -->
    <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/plugins/jqvmap/jqvmap.min.css">
    <!-- Theme style -->
    <!-- <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/dist/css/adminlte.min.css">-->    
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/plugins/daterangepicker/daterangepicker.css">
    <!-- summernote -->
    <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/plugins/summernote/summernote-bs4.min.css">
    <!-- DataTables -->
    <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
     <!-- Select2 -->
    <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/plugins/select2/css/select2.min.css">
    <!-- Toastr -->
  ...
  <!-- ChartJS -->
  <script src="<?php echo base_url();?>resource/adminlte/plugins/chart.js/Chart.min.js"></script>
  <!-- Sparkline -->
  <script src="<?php echo base_url();?>resource/adminlte/plugins/sparklines/sparkline.js"></script>
  <!-- JQVMap -->
  <script src="<?php echo base_url();?>resource/adminlte/plugins/jqvmap/jquery.vmap.min.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
  <!-- jQuery Knob Chart -->
  <script src="<?php echo base_url();?>resource/adminlte/plugins/jquery-knob/jquery.knob.min.js"></script>
  <!-- jquery-validation -->
  ...
  <!-- Tempusdominus Bootstrap 4 -->
  <script src="<?php echo base_url();?>resource/adminlte/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
  <!-- Summernote -->
  <script src="<?php echo base_url();?>resource/adminlte/plugins/summernote/summernote-bs4.min.js"></script>
  <!-- overlayScrollbars -->
  <script src="<?php echo base_url();?>resource/adminlte/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
  <!-- AdminLTE App -->
  ...
  <!-- Select2 -->
  <script src="<?php echo base_url();?>resource/adminlte/plugins/select2/js/select2.full.min.js"></script>
  <!-- AdminLTE App -->
  ...
  <script type="text/javascript" src="<?php echo base_url();?>resource/adminlte/plugins/fastclick/fastclick.js"></script>
  ...
  <!--  <script type="text/javascript" src="<?php echo base_url();?>assets/js/bootstrap-clockpicker.min.js">
  </script>  -->
  <!-- DataTables  & Plugins -->
  <script src="<?php echo base_url();?>resource/adminlte/plugins/datatables/jquery.dataTables.min.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/datatables-responsive/js/dataTables.responsive.min.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/datatables-responsive/js/responsive.bootstrap4.min.js"></script>
  <script src="<?php echo base_url();?>assets/js/jquery.slugit.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/datatables-buttons/js/dataTables.buttons.min.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/datatables-buttons/js/buttons.bootstrap4.min.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/jszip/jszip.min.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/pdfmake/pdfmake.min.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/pdfmake/vfs_fonts.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/datatables-buttons/js/buttons.print.min.js"></script>
  <script src="<?php echo base_url();?>resource/adminlte/plugins/datatables-buttons/js/buttons.colVis.min.js"></script>
  ...
  <script type="text/javascript">
      $(document).ready(function(){
        $("#campusID").change(function(){
          ...
          $.ajax({
            type: "POST",
            url: "admin.php?c=ajax&m=changeCampus",
            data: dataString,
            cache: false,
      ...
      $(document).ready(function(){
        $("#sessionID").change(function(){
          ...
          $.ajax({
            type: "POST",
            url: "admin.php?c=ajax&m=selectSession",
            data: dataString,
            cache: false,
            success: function(html)
            {
    ...
    $(document).ready(function(){
        $("#schoolshortname").modal('show');
          ...
          var systemID = $('#systemID').val();
            ...
            $.ajax({
              url: 'admin.php?c=profile_system&m=updateRegText',
              type: 'POST',
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="modal fade" id="schoolshortname" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
          <input type="hidden" name="systemID" id="systemID" value="<?php echo $schoolinfo->system_id; ?>">
    ...
    <!-- Navbar -->
      <nav class="main-header navbar navbar-expand text-white" style="background-color: #3c8dbc;padding: 0px;">
        <ul class="navbar-nav col-lg-12">
          ...
          <ul class="navbar-nav col-lg-6">
            ...
            <li class="nav-item d-none d-sm-inline-block nav-link" style="font-size: 14px;">
               <a style="padding-top: 5px;" class="nav-link" href="#"> <?php //echo $plan_info->plan_name;?></a>
            </li>
            ...
            <li class="nav-item d-sm-inline-block nav-link col-lg-3 col-sm-4">
              <select name="session_id" id="sessionID" class="form-control">
                <?php foreach ($academic_sessions as $academic_session){ ?>
                  <option value="<?php esc($academic_session->session_id); ?>" 
                    <?php  if($curr_session_id == $academic_session->session_id){ echo 'selected'; } ?>>
                    <?php print_r($academic_session->session_name); ?>
                  </option>
                <?php } ?>
              </select>
            </li>
       ...
       <?php 
          // if($user->photo){
          // $imgurl = FCPATH."employees-img/".$user->photo;
          // if(file_exists($imgurl)){
          // $profile_photo = " <img class='user-image' src='".base_url("employees-img/".$user->photo)."' > ";
          // }else{
          // $profile_photo = " <i style='margin-right:6px;font-size: 20px;float:left;display: block;' class='fa fa-user'></i> ";
          // }
          // }else{
          // $profile_photo = " <i style='margin-right:6px;font-size: 20px;float:left;display: block;' class='fa fa-user'></i> ";
          // } 
      ...
      <li class="dropdown user user-menu pull-right">
        <a class="nav-link" style="margin-top:5px;" href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> 
         <?php if (!empty($user) && !empty($user->photo)): ?>
              <img class="user-image" src="<?= base_url('employees-img/' . $user->photo) ?>" />
          <?php else: ?>
        ...
        <ul class="dropdown-menu">
          ...
          <?php 
            ...
            // $imgurl = FCPATH."employees-img/".$user->photo;
            // if(file_exists($imgurl)){
            // $profile_photo = "<img style='width:50px;height:50px;text-align: center;display: block;border-radius: 30px;margin: 0 auto;' src='".base_url("employees-img/".$user->photo)."' >";  
            // }else{
            ...
            <li class="user-footer">
              <div class="pull-left d-none d-sm-block" style="float: left;"> 
                <a href="<?php echo '#/profile';?>" class="btn btn-default btn-flat">
                  <i class="fa fa-gear">
                  </i> Profile
                </a> 
              </div>
              <div class="pull-right" style="float: right;"> 
                <a href="<?php echo site_url('c=logout');?>" class="btn btn-default btn-flat">
...
<?php } ?>>
  <!-- Brand Logo -->
  <a style="padding: 7px; background-color: #3c8dbc;" href="<?php echo site_url('');?>" class="brand-link">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true" >
        <li><div class="image text-center">
          <?php if($schoolinfo){ ?> 
          <img style="height: 70px; text-align: center;max-width: 100%;" src="<?php echo base_url();?>system-logo/<?php echo $schoolinfo->logo; ?>">
          <?php } ?>
        </div></li>
        <li class="nav-item">
