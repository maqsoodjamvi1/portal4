...
<html lang="en">
  <head>
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="<?php echo base_url();?>resource/adminlte/plugins/summernote/summernote-lite.min.css">
    <!-- DataTables -->
...
<script src="<?php echo base_url();?>assets/js/datetimepicker-compat.js?v=20260614"></script>
  <!-- Summernote -->
  <script src="<?php echo base_url();?>resource/adminlte/plugins/summernote/summernote-lite.min.js"></script>
  <!-- overlayScrollbars -->
          ...
          <?php 
            ...
            <li class="user-footer">
              <div class="float-start d-none d-sm-block" style="float: left;"> 
                <a href="<?php echo '#/profile';?>" class="btn btn-secondary btn-flat">
                  <i class="fa fa-gear">
                  </i> Profile
                </a> 
              </div>
              <div class="float-end" style="float: right;"> 
                <a href="<?php echo site_url('c=logout');?>" class="btn btn-secondary btn-flat">
