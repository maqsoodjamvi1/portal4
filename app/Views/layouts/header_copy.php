      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true" >
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <?php if(hasPermission('admin-test-series')){ ?>
            <li class="nav-item"> 
              <a href="<?= base_url('admin/test_series') ?>" class="nav-link"> 
                <i class="nav-icon fa fa-list"></i> 
                <p>Test Series</p> 
              </a> 
            </li>  
            <li class="nav-item"> 
              <a href="<?= base_url('admin/tests') ?>" class="nav-link"> 
                <i class="nav-icon fa fa-list"></i> 
                <p>Tests</p> 
              </a> 
            </li>  
            ...
            <li class="nav-item"> 
              <a href="<?= base_url('admin/test-result-card') ?>" class="nav-link"> 
                <i class="nav-icon fa fa-list"></i> 
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <?php if(hasPermission('admin-add-student-attendance')){ ?>
            <li class="nav-item"> 
              <a href="<?= base_url('admin/students_attendance/add') ?>" class="nav-link"> 
                <i class="nav-icon far fa-address-card"></i> 
            ...
            <li class="nav-item"> 
              <a href="<?= base_url('admin/day_on_reset/add') ?>"" class="nav-link"> 
            ...
            <li class="nav-item"> 
              <a href="<?= base_url('admin/students_latecomming/add') ?>"" class="nav-link"> 
            ...
            <li class="nav-item"> 
              <a href="<?= base_url('admin/students_earlyleft/add') ?>"" class="nav-link">  <i class="nav-icon far fa-clock"></i> 
                <p>Early Left</p> 
              </a> 
            </li>
            <?php } ?> 
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <?php if(hasPermission('admin/admin-notices')){ ?>
            <li class="nav-item"> 
            ...
            <li class="nav-item"> 
              <a href="<?= base_url('admin/student-notices') ?>"" class="nav-link"> 
                <i class="nav-icon fas fa-bell"></i> 
                <p>Student Notices</p>
              </a>
            </li>
      ...
      <?php } ?>
        ...
        <?php if(hasPermission('admin-academy')){ ?>
          ...
          <ul class="nav nav-treeview">
            ...
            <!-- <li class="nav-item"> 
              <a href="<?= base_url('a_subjects') ?>" class="nav-link"> 
                <i class="nav-icon fa fa-list"></i> 
                <p>Subjects</p>
              </a> 
            </li>
            <li class="nav-item"> 
              <a href="<?= base_url('a_classes') ?>" class="nav-link"> 
                <i class="nav-icon fa fa-list"></i> 
                <p>Classes</p>
              </a> 
            </li> -->
           ...
           <!--  <li class="nav-item"> 
              <a href="<?= base_url('admin/a_teacher_subjects/add') ?>"" class="nav-link"> 
                <i class="nav-icon fa fa-list"></i> 
