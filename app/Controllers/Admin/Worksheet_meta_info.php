...
class Worksheet_meta_info extends MY_Controller {
	...
	*/
	...
	{
		$this->load->view('worksheet_meta_info', $this->template_data);
	}
	...
	function add(){
		...
		$this->load->view('worksheet_meta_info_edit', $this->template_data);

	}

	function selectWorksheetsByID(){
    ...
    foreach ($worksheetinfo as $key => $value) { 
      ...
      $path .='<tr><td>	
             ...
             <input type="text" id="meta_title'.$i.'" class="form-control" placeholder="Meta Title" name="meta_title'.$i.'" value="'.$value->meta_title.'">
          	...
          	$path .='<textarea rows="3" placeholder="Meta Title" name="meta_keyword'.$i.'" class="form-control">'.$value->meta_keywords.'</textarea></td><td> 
			<textarea rows="3" placeholder="Meta Description" name="meta_description'.$i.'" class="form-control">'.$value->meta_description.'</textarea></td><td>';
      '</td>
		...
		$path .= '</tbody><tfoot><tr><td colspan="5" style="text-align: left;"></td></tr><tr></tr></tfoot></table>'; 
