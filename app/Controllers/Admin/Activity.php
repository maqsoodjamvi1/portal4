 ...
 * @copyright	Copyright (c) 2018-219 TIME Soft Solutions
...
class Activity extends MY_Controller {
	...
	function __construct(){
		parent::__construct();
		check_permission('admin-activity');
	}
	...
	*/
	...
	{
		$this->load->view('activity', $this->template_data);
	}
	...
	function add(){
		check_permission('admin-add-activity');
		...
		$this->load->view('activity_edit', $this->template_data);
	...
	function edit(){
		...
		check_permission('admin-edit-activity');
	...
	function delete(){
		...
		check_permission('admin-del-activity');
