...
/**
 * English Text Fill in Blanks Manage
 *
 * @author		Maqsood Ahmed
 * @copyright	Copyright (c) 2018-2019 TIME Soft Soltions
 * @email		maqsoodjamvi@gmail.com
 * @filesource
 */

class Eng_text_fb extends MY_Controller {
	...
	public function index()
	{
		...
		$this->load->view('eng_text_fb', $this->template_data);
	}
    ...
    $data[] = array(
        'id' => $row->content_id,
        'subject' => $subjects_info->subject_name,
...
function add(){
    ...
    $this->load->view('eng_text_fb_edit', $this->template_data);
}
        ...
        $optionscount = $this->input->post('optionscount');
            ...
            for($j=0; $j<1; $j++){	
                ...
                $optionsdata = array(
                    ...
                    'option_text' => trim($this->input->post('option_text'.$j.$i)),
                );
