...
class VocabTopics extends BaseController
{
    protected $db;
    protected $session;
 ...
 $systemId = 0;
        ...
        return view('admin/vocab_topics_bulk', [
            'classes' => $classes,
        ]);
    }
    ...
    public function data(): ResponseInterface
    {
        ...
        $rows = $this->db->table('vocab_topics')
 ...
 public function saveBulk(): ResponseInterface
{
    ...
    try {
        ...
        $existing = $db->table('vocab_topics')
            ->select('id, topic_name')
            ->where('class_id', $classId)
            ->where('subject_id', $subjectId)
            ->get()->getResultArray();
