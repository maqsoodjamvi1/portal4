...
class FeeChalanPay extends BaseController
{
 ...
 helper(['form', 'url']);
    ...
    public function index()
    {
        ...
        return view('admin/fee_chalan_pay', [
...
public function getStudentCardAjax()
{
    ...
    foreach ($siblings as $sibling) {
        ...
        $studentDetails[] = [
            ...
            'student_name' => $sibling->first_name . ' ' . ($sibling->last_name ?? ''),
            'monthly_fee' => $studentMonthlyFee,
    ...
    <div class="parent-header bg-light p-2 mb-2 rounded">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
         ...
         <button type="button" onclick="showFamilyFeeHistoryPage(<?= $student->parent_id ?>)">
    Show Family Fee History
</button>
...
protected function generateStudentFeeCard($student, $campus_info, $session_id)
{
  ...
  $fee_chalan = $this->db->table('fee_chalan fc')
    ...
    return '
    <div class="student-card mb-4 card shadow-sm border-0" data-student-id="' . esc($student->student_id) . '" data-parent-id="' . esc($student->parent_id) . '">
        <!-- Header -->
            ...
            <div class="text-right mt-2 mt-md-0">
                ...
                <div class="btn-group btn-group-sm">
                    ...
                    <a class="btn btn-info"
                        ...
                        <i class="fas fa-file-invoice"></i> Generate Chalan
                    </a>
                </div>
            </div>
        </div>
