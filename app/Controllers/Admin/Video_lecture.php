...
class Video_lecture extends MY_Controller {
	...
	function __construct(){
		...
		check_permission('admin-video-lecture');
...

	{
		...
		$this->load->view('video_lecture', $this->template_data);
	...
	function add(){
		...
		check_permission('admin-add-video-lecture');
		...
		$this->load->view('video_lecture_edit', $this->template_data);
	...
	function edit(){
		...
		check_permission('admin-edit-video-lecture');
