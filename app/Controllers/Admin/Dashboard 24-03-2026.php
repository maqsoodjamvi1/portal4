...
public function index()
{
    ...
    // ========== ADD THIS: Check if user is teacher ==========
    $userRoles = currentUserRoles();
    $isTeacher = (in_array('teacher', $userRoles) || in_array('faculty', $userRoles));
    
    // Debug log (remove in production)
    log_message('debug', 'Dashboard - User Roles: ' . print_r($userRoles, true));
    log_message('debug', 'Dashboard - Is Teacher: ' . ($isTeacher ? 'Yes' : 'No'));
    // ========== END ADD ==========
    ...
    $data = array_merge([
        ...
        // ========== ADD THIS: Pass isTeacher to view ==========
        'isTeacher' => $isTeacher,
        // ========== END ADD ==========
    ], $feeSummaryData);
