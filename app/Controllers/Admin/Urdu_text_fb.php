...
/**
 * Urdu Text Fill In The Blanks Manage
 *
...
class Urdu_text_fb extends MY_Controller {
	...
	*/
	...
	public function index()
	{
		...
		$this->load->view('urdu_text_fb', $this->template_data);
	}
...
function add(){
	...
	$this->load->view('urdu_text_fb_edit', $this->template_data);
}
