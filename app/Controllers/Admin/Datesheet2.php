...
class Datesheet2 extends BaseController
{
    protected $db;
    protected $session;
    ...
    public function index()
    {
        ...
        return view('admin/datesheet2', $this->template_data);
    }
    ...
    {
        $hide_marks = $this->request->getGet('hide_marks') ?? '';
                        ...
                        if ($Secsubjects) {
                            ...
                            if ($academicsubjects) {
                                ...
                                if ($datesheet->total_marks > 0) {
                                    if ($hide_marks == '') {
                                        $subjectdatesheet[] = [
                                            'exam_date' => $exam_date . '<br>' . $dayOfWeek,
                                            'subjectname' => $subjectname . ' (' . $datesheet->total_marks . ')',
