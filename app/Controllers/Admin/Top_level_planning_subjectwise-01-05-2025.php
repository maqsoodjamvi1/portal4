...
class Top_level_planning_subjectwise extends MY_Controller {
	...
	public function index()
	{
		...
		foreach($section_subjects as $subect_id){
		  ...
		  $top_level_planning_data = $this->db->query('SELECT * FROM timeschool.top_level_planning where  class_id = '.$classsection->class_id.' and subject_id = '.$subect_id->subject_id.' and term_session_id='.$value->term_session_id)->row(); 
...
$this->load->view('top_level_planning_subjectwise', $this->template_data);
}
}
