...
class Urdu_text_mcqs extends MY_Controller {
	...
	*/
	...
	public function index()
	{
		...
		$this->load->view('urdu_text_mcqs', $this->template_data);
	}
...
function add(){
	check_permission('admin-add-questions');
	...
	$this->load->view('urdu_text_mcqs_edit', $this->template_data);
	}
	
	function edit(){
		check_permission('admin-edit-questions');
